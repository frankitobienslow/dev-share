...
const Register = () => {
  ...
  return (
    <View className="flex-1 bg-blue-100 justify-center items-center p-4">
      ...
      />
      <Formik
        initialValues={{ dni: '', nombre: '', apellido: '', email: '', password: '', confirmPassword: '', userType: '' }}
      ...
      >
        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
          <View className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            {touched.userType && errors.userType && <Text style={{ color: 'red' }}>{errors.userType}</Text>}

            <Pressable className="bg-blue-500 rounded-lg p-4 mb-4" onPress={handleSubmit}>
